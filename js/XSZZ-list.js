...
//横线长度问题
  var wordLength = $(".lists-title").children("h1").text().length;
  if(wordLength > 5) {
    $(".lists-title").children("h1").css({"background":"url(images/middleline02.png) center center no-repeat"});
  }
  else if(wordLength <= 5) {
    $(".lists-title").children("h1").css({"background":"url(images/longline.png) center center no-repeat"});
  }
