...
$(document).ready(function(){
  ...
  if(wordLength > 5) {
    $(".lists-title").children("h1").css({"background":"url(images/middleline.png) center center no-repeat"});
  }
  else if(wordLength <= 5) {
    $(".lists-title").children("h1").css({"background":"url(images/line.png) center center no-repeat"});
  }
