...
//列表hover效果
$(".organization-lists").find("li").mouseover(function(){
  $(this).find("h1").css({"color":"#5eabec"});
  $(this).css({"border":"1px solid #000"});
});
$(".organization-lists").find("li").mouseout(function(){
  $(this).find("h1").css({"color":"#132840"});
  $(this).css({"border":"1px solid #132840"});
});

//爱特工作室logo太大了……
var imgs = $(".organization-lists").find("img").length;
for(i=0;i<imgs;i++) {
  if($(".organization-lists").find("img").eq(i).attr("src")=="images/itStudio.png") {
    $(".organization-lists").find("img").eq(i).css({"height":"auto","width":"320px","margin-top":"60px"});
  }
}
