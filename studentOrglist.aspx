<%@ Page Title="" Language="C#" MasterPageFile="~/Display/MasterPage.master" AutoEventWireup="true" CodeFile="studentOrglist.aspx.cs" Inherits="Display_studentOrglist" %>
...
<script type="text/javascript">
    var $aside = $(".left-nav");
    $aside.children("ul").children("li").eq(6).css({ "background": "url(images/left-nav-second-click.png) no-repeat" });
    $aside.children("ul").children("li").eq(6).children("a").css({ "color": "#fff" });
</script>
</asp:Content>
