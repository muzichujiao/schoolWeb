...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<ul>
		<li>课程名称:
			...
			<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ErrorMessage="不能为空" ControlToValidate="courseName" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		<li>开课院系:
		...
		<li>课程编号:
			...
			<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"  ForeColor="Red" ErrorMessage="不能为空" ControlToValidate="CoNumber" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		<li>课程英文名称:
			<asp:TextBox ID="EnglishName" runat="server"></asp:TextBox>
			<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="不能为空" ForeColor="Red" ControlToValidate="EnglishName" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		<li>课程总学时（请输入数字）:
			<asp:TextBox ID="TotalHours" runat="server"></asp:TextBox>
			<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ForeColor="Red" ControlToValidate="TotalHours" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		<li>课程总学分（请输入数字）:
			<asp:TextBox ID="TotalMark" runat="server"></asp:TextBox>
			<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ForeColor="Red" ControlToValidate="TotalMark" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		...
		<li>推荐使用教材:
			...
			<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ForeColor="Red" ControlToValidate="Textbook" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		<li>推荐使用教材编者:
			<asp:TextBox ID="TextbookAuthor" runat="server"></asp:TextBox>
			<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ForeColor="Red" ControlToValidate="TextbookAuthor" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		<li>推荐使用教材出版社:
			<asp:TextBox ID="TextbookPublisher" runat="server"></asp:TextBox>
			<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ForeColor="Red" ControlToValidate="TextbookPublisher" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		<li>推荐使用教材出版时间及版次:
			<asp:TextBox ID="TextbookVersion" runat="server"></asp:TextBox>
			<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ForeColor="Red" ControlToValidate="TextbookVersion" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		...
		<li>课程教学目标与基本要求:
			...
			<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ForeColor="Red" ControlToValidate="CourseObject" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
		...
		<li>考试形式:
			...
			<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ForeColor="Red" ControlToValidate="ExamType" ErrorMessage="不能为空" Display="Dynamic" ValidationGroup="1"></asp:RequiredFieldValidator>
		</li>
